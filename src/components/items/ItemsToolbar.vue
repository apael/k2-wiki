...
const hasActiveFilters = computed(() =>
  props.typeFilter !== 'all' || props.sourceFilter !== 'all' || props.searchQuery !== '' || props.sourceSubFilter.size > 0
)
  ...
  <div class="surface-card p-4 sm:p-5">
    <div class="flex flex-wrap items-center gap-3">
      ...
      >
        ...
        Filters
        <span v-if="hasActiveFilters" class="flex size-5 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-primary-foreground">!</span>
      </button>
    </div>
    ...
    >
      <div class="flex flex-wrap items-center gap-2.5" role="radiogroup" aria-label="Filter by type">
      ...
      <div class="flex flex-wrap items-center gap-2.5" role="radiogroup" aria-label="Filter by source">
        <span class="text-xs font-semibold uppercase tracking-[0.15em] text-muted-foreground">Source</span>
        <button
        ...
        <div class="ml-auto flex items-center gap-2">
          ...
          <div class="rounded-full border border-border bg-muted/40 px-3 py-1 text-xs font-semibold text-muted-foreground" aria-live="polite">
      ...
      <div v-if="props.availableSubFilters.length > 0" class="flex flex-wrap items-center gap-2.5">
        <span class="text-xs font-semibold uppercase tracking-[0.15em] text-muted-foreground/60">└</span>
        <button
